...
public:
	...
	void printIndented(void visit(ItemType &, int count)) const;
...
private:   
	...
	void _printIndented(void visit(ItemType &, int count), BinaryNode<ItemType>* nodePtr, int height) const;
}; 
...
template<class ItemType>
void BinaryTree<ItemType>::printIndented(void visit(ItemType &, int count)) const
{
	int height = 1;
	_printIndented(visit, rootPtr, height);
}
